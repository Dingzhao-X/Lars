...
const uint32_t TableStruct_msg_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::qps_test::echo_message, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::qps_test::echo_message, content_),
  PROTOBUF_FIELD_OFFSET(::qps_test::echo_message, id_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::qps_test::echo_message)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::qps_test::_echo_message_default_instance_._instance,
};

const char descriptor_table_protodef_msg_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\tmsg.proto\022\010qps_test\"+\n\014echo_message\022\017\n"
...
const ::_pbi::DescriptorTable descriptor_table_msg_2eproto = {
    false, false, 74, descriptor_table_protodef_msg_2eproto,
    "msg.proto",
...
echo_message::echo_message(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:qps_test.echo_message)
}
echo_message::echo_message(const echo_message& from)
  ...
  id_ = from.id_;
  // @@protoc_insertion_point(copy_constructor:qps_test.echo_message)
}
...
echo_message::~echo_message() {
  // @@protoc_insertion_point(destructor:qps_test.echo_message)
...
// @@protoc_insertion_point(message_clear_start:qps_test.echo_message)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "qps_test.echo_message.content"));
        } else
          goto handle_unusual;
        continue;
      // int32 id = 2;
...
uint8_t* echo_message::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:qps_test.echo_message)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:qps_test.echo_message)
  return target;
}

size_t echo_message::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:qps_test.echo_message)
  size_t total_size = 0;
...
void echo_message::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<echo_message *>(to)->MergeFrom(
      static_cast<const echo_message &>(from));
}


void echo_message::MergeFrom(const echo_message& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:qps_test.echo_message)
...
// @@protoc_insertion_point(class_specific_copy_from_start:qps_test.echo_message)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::qps_test::echo_message*
Arena::CreateMaybeMessage< ::qps_test::echo_message >(Arena* arena) {
  return Arena::CreateMessageInternal< ::qps_test::echo_message >(arena);
}
